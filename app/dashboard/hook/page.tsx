    ...
    <div className="p-8 max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-cyan-500 via-blue-600 to-purple-600 p-[1.5px] shadow-lg shadow-cyan-500/20 flex items-center justify-center flex-shrink-0">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-black text-white tracking-tight">Vibe<span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Hook</span></h1>
              <span className="text-[10px] uppercase font-black tracking-widest px-2 py-0.5 rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-500/40">Retention Architect</span>
            </div>
            <p className="text-white/40 text-xs sm:text-sm mt-0.5">Generate scroll-stopping hooks, thumbnail text, and high-retention openings for any niche.</p>
          </div>
        </div>
      </motion.div>
